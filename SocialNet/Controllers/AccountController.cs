...
namespace SocialNet.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IRepository newRepository)
        {
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    return RedirectToAction("FillInFields", "Account");
                }
        ...
        [HttpGet]
        public ActionResult FillInFields()
        {
            return View(repository.FindUserById(WebSecurity.CurrentUserId));
        }

        [HttpPost]
        public ActionResult FillInFields(User user)
        {
            repository.SaveFields(user);
